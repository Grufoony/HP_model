...
At this point, we can define as \emph{Self-Avoiding Walk} (SAW) a lattice path that does not visit the same point more than once, see Fig. \ref{fig:src_example}.
...
It has been proven \cite{trueSAW} that a SAW differentiates from a Self-Repelling Chain (polymer problem) by a statistical point of view.
